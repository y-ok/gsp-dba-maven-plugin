...
public class GenerateEntityTest extends AbstractDdlMojoTest<GenerateEntity> {
    ...
    /**
     * テーブルのデータ型を網羅するJSR310に対応したEntity生成テスト。
     * <p>
     * <h4>検証内容</h4>
     * <ul>
     * <li>各DBごとにサポートするデータ型を網羅したテーブルを元にEntityを生成するテスト。</li>
     ...
     * <ul>
     * <li>期待値Entityフォルダと同一であること。</li>
     * <li>各DBのTIME型、DATE型、TIMESTAMP型がそれぞれLocalTime, LocalDate, LocalDateTime型に変換されること。</li>
     * </ul>
     *
     * @throws Exception
     */
    ...
    /**
     * テーブルのデータ型を網羅するDoma用のJSR310に対応したEntity生成テスト。
     * <p>
     * <h4>検証内容</h4>
     * <ul>
     * <li>各DBごとにサポートするデータ型を網羅したテーブルを元にEntityを生成するテスト。</li>
